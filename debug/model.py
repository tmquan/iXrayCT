...
class PGNet(nn.Module):
    def __init__(self, 
        ...
        self.transformation = nn.Sequential(
            ...
            EqualLinear(num_filters*num_factors[8], 512),
            ScaledLeakyReLU(),
            # EqualLinear(num_filters*num_factors[8], num_filters*num_factors[8]),
            # ScaledLeakyReLU(),
            # nn.Dropout(),
        ...
        self.generator = Generator(self.hparams.shape, self.hparams.latent, self.hparams.n_mlp, channel_multiplier=self.hparams.channel_multiplier)
    ...
    def forward(self, x):
        ...
        out, latent = self.generator([transforms], return_latents=True)
        return out, latent
