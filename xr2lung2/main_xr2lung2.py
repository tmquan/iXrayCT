...
valid_image_dir = ['/u01/data/iXrayCT_COVID/data_resized/test/xr2lung2/JSRT/neg/images/']
valid_label_dir = ['/u01/data/iXrayCT_COVID/data_resized/test/xr2lung2/JSRT/neg/labels/']
...
class Down(nn.Module):
    def __init__(
        ...
        self.net = nn.Sequential(
            ...
            nn.Conv2d(in_ch, in_ch, kernel_size=4, stride=2),
